  ...
  return (
    ...
    <Transition appear show={isOpen} as = {Fragment}>
      <Dialog as="div" className="relative z-10"  onClose={closeModel}>
        ...
        >
          <Dialog.Panel className="relative w-full max-height-[90vh] max-w-lg overflow-y-auto transform rounded-2xl p-6 bg-white 
          text-left shadow-xl transition-all flex flex-col gap-5">
            <button type='button' onClick={closeModel} className="absolute z-10 w-fit top-2 right-2 p-2 bg-primary-blue-100 rounded-full">
